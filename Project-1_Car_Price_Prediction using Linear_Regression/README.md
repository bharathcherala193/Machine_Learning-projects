...
This project predicts the selling price of a used car using Machine Learning. I used Linear Regression to understand how different car features affect the resale price.
